...
export const COLLECTION_MOVIE_DETAILS_REQUESTED = 'COLLECTION_MOVIE_DETAILS_REQUESTED';
export const COLLECTION_MOVIE_DETAILS_LOADED = 'COLLECTION_MOVIE_DETAILS_LOADED';
export const COLLECTION_MOVIE_DETAILS_ERROR = 'COLLECTION_MOVIE_DETAILS_ERROR';

export const COLLECTION_CAST_REQUESTED = 'COLLECTION_CAST_REQUESTED';
export const COLLECTION_CAST_LOADED = 'COLLECTION_CAST_LOADED';
export const COLLECTION_CAST_ERROR = 'COLLECTION_CAST_ERROR';